    ...
    <table class="table table-striped table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <img src="<?=$student['image']?>" alt="Student Image" style="width: 50px; height: 50px; object-fit: cover;" /> <!-- Display image -->
                </td>
                <td><?=$student['name']?></td>
                <td><?=$student['email']?></td>
                <td><?=$student['phone']?></td>
            ...
            <?php 
                ...
                echo "<tr><td colspan='6'>No data available</td></tr>"; // Adjusted colspan
            }
            ?>
        </tbody>
    </table>
